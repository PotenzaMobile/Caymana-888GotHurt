...
class Settings {
    ...
    public static let HOST = "888gothurt.com" /// if url has "www" then add host like "www.domain.com" else would be white screen
    
    public static let URL = "https://888gothurt.com/"
